...
class Dictionary:
    ...
    def keys(self) -> Any:
        return (cell[0] for cell in self._cells if cell is not None)

    def values(self) -> Any:
        return (cell[2] for cell in self._cells if cell is not None)

    def items(self) -> Any:
        return ((cell[0], cell[2]) for cell in self._cells if cell is not None)

    def update(self, dictionary: dict | "Dictionary") -> None:
